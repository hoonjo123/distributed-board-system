package joney.board.hotarticle.repository;
...
class HotArticleListRepositoryTest {
    ...
    void addTest() throws InterruptedException {
        // given
        LocalDateTime time = LocalDateTime.of(2026, 6, 30, 0, 0);
        // 상위3건
        long limit = 3;
        ...
        // then
        List<Long> articleIds = hotArticleListRepository.readAll("20260630");
        ...
        assertThat(hotArticleListRepository.readAll("20260630")).isEmpty();
    }
}