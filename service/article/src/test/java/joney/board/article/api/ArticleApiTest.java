...
public class ArticleApiTest {
    ...
    @Test
    void createTest(){
        ArticleResponse response = create(new ArticleCreateRequest("제목", "내용", 1L, 1L));
    ...
    @Test
    void readTest(){
        ArticleResponse response = read(327353598674698240L);
        System.out.println("res = " + response);
    }
    ...
    @Test
    void updateTest(){
        update(327353598674698240L);
        ArticleResponse response = read(327353598674698240L);
        System.out.println("수정 완료" + response);
    }

    void update(Long articleId){
        restClient.put()
                .uri("/v1/articles/{articleId}", articleId)
                .body(new ArticleUpdateRequest("수정된 제목", "수정된 내용"))
                .retrieve()
                .body(ArticleResponse.class);
    }
    ...
    void deleteTest(){
        restClient.delete()
                .uri("/v1/articles/{articleId}", 327353598674698240L)
                .retrieve()
                .body(Void.class);
